...
O código abaixo usa loop e programação funcinal, respectivamente.
...
A biblioteca `bench` oferece funções ótimas para avaliara performance de pedaços pequenos de código.
