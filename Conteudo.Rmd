...
![](diagramas/modulos_shiny.png){width="80%"}
...
![](diagramas/modulos_shiny_2.png){width="80%"}
...
![](diagramas/modulos_shiny_3.png){width="80%"}
...
A biblioteca ggiraph ajuda a transformar o gráfico gerado pela ggplot em um html widget. 

Ou seja, o gráfico deixa de ser uma figura estática mostrada pela aplicação e passa a ser um objeto html que pode ter comportamento controleado por javascript.
