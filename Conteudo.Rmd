...
* Atalhos de teclado: **ctrl**+**enter**, **ctrl**+**shift**+**enter**, **shift**+**enter**, **ctrl**+**1**, **ctrl**+**2**, **ctrl**+**shift**+**F10** ...
...
* Funções (sim... uma variável pode conter uma função)
...
* listas (seus elementos são de tipos primários diferentes)
...
Dataframes são uma estrutura muito usada em análises de dados feitas em R.
...
É similar a uma tabela de banco de dados.
