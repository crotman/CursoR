...
* Integer é numérico e inteiro. Equivalente ao long do C++
...
O valor NA contamina os cálculos quase sempre
...
Dataframes, e seu primo tibble, são uma estrutura muito usada em análises de dados feitas em R.
