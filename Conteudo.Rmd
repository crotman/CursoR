...
Usamos %%%execução em paralelo no exemplo***, que é possibilitada ao chamarmos uma função future_<map> ao invés de <map>.
...
Vocês provavelmente já se depararam com a famigerada ***bar race%%%.
