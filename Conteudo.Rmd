...
Tidymodels é um conjunto de bibliotecas que cuida de todos os passos necessários para o workflow de seleção e avaliação de modelos de aprensizado estatístico.


Com ele podemos definir:


* Procedimentos de Feature Engineering

* 



![tidymodels](imagens/tidymodels.svg)
...
+----------------------------------------------------------------------------------+--------------------------------------------------------------------------------+---------------------------------------------------+
| -Funções básicas para o tsibble (tibble temporal)![tsibble](imagens/tsibble.png) | -Funções pra extrações de features e estatísticas![feasts](imagens/feasts.png) | -Funções para projeção![fable](imagens/fable.png) |
+----------------------------------------------------------------------------------+--------------------------------------------------------------------------------+---------------------------------------------------+
