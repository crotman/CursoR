...
author: "Bruno Crotman (crotman@gmail.com)"
date: "11/02/2020"
output: 
    slidy_presentation: 
      css: styles.css
...
gd <- st_read("dados/gd/Geração_Distribuída.shp")
...
brazil <- c(left = -75, bottom = -36, right = -30, top =5)

get_stamenmap(brazil, zoom = 5, maptype = "toner-lite") %>% 
  ggmap() +
  geom_sf(data = gd_sample, inherit.aes = FALSE)

ggplot() +
  geom_sf(data = gd_sample)
