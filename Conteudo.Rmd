...
## Escolhendo o melhor gráfico: distribuição
...
ggplot(real_simulado) + 
  geom_histogram(
    aes(x = gols, fill = tipo),
    binwidth = 1,
    position = "dodge"
...
## Escolhendo o melhor gráfico: distribuição (com uma brincadeirinha)
...
## Aplicação de funções a data frames (purrr)
