...
funções derivadas da `mutate` possibilitam a alteração de várias colunas ao mesmo tempo, usando os mesmos helpers que jã vimos para a `select` e  
...
Outras funções muito usadas são a `lag()` e `lead()`, que acessam a linha anterior do tibble.
